...
SWIFT_CLASS("_TtC11Marketcloud12Reachability")
...
- (nullable instancetype)initWithHostname:(NSString * __nonnull)hostname error:(NSError * __nullable * __null_unspecified)error;
+ (Reachability * __nullable)reachabilityForInternetConnectionAndReturnError:(NSError * __nullable * __null_unspecified)error;
+ (Reachability * __nullable)reachabilityForLocalWiFiAndReturnError:(NSError * __nullable * __null_unspecified)error;
+ (NSString * __nonnull)checkConnectionType;
+ (BOOL)isConnectedToNetwork;
- (BOOL)startNotifierAndReturnError:(NSError * __nullable * __null_unspecified)error;
- (void)stopNotifier;
- (BOOL)isReachable;
